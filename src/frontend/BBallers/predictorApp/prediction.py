...
player_dict = pickle.load(open(os.path.join(settings.STATIC_ROOT, 'predictorApp/production/players.p'), 'rb'))
player_team_dict = pickle.load(open(sos.path.join(settings.STATIC_ROOT, 'predictorApp/production/players_team.p'), 'rb'))
